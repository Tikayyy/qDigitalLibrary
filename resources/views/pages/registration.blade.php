...
@section('content')
    <form action="" method="post" class="text-center">
        @csrf
        <div class="mb-2">
            <input class="form-control" type="text" placeholder="Name" name="name" aria-label="default input example" @if(old('name')) value="{{ old('name') }}" @endif>
        </div>
        <div class="mb-2">
        ...
        <div class="d-grid gap-2">
            ...
            <a class="btn btn-secondary p-0" type="button" href="{{ route('login') }}">
